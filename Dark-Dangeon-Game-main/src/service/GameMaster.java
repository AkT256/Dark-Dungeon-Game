...
public class GameMaster {
    ...
    public Integer coinsInYourPocket = 0;
    public Integer coinsRemained = 9;
    ...
    public void renderFrame(Graphics graphics) {
        if (!isExitReached()) {
            ...
            graphics.drawString(coinsInYourPocket.toString(), 100, 20);
            graphics.drawString(coinsRemained.toString(), 120, 20);
        } else {
